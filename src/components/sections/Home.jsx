  ...
  return (
    ...
    >
      ...
      <img
        src={logo}
        alt="logo"
        className="hover:scale-110 absolute top-2 right-4 md:top-6 md:right-8 w-24 md:w-42 transition-transform z-30"
      />
      ...
      >
        <button
          ...
          className="w-100 h-12 md:w-150 md:h-13 lg:w-150 lg:h-15 bg-[#f9b9c3] text-[#fff8e8] text-base md:text-lg lg:text-xl font-bold py-2 md:py-2 lg:py-4 rounded-full border-2 border-[#99805E] shadow-md hover:bg-[#f8a9b6] transition transform hover:scale-105"
        >
          Play Mini Game
        </button>
        ...
        <button
          ...
          className="w-100 h-12 md:w-150 md:h-13 lg:w-150 lg:h-15 bg-[#fff3b2] text-[#f8a9b6] text-base md:text-lg lg:text-xl font-bold py-2 md:py-2 lg:py-4 rounded-full border-2 border-[#99805E] shadow-md hover:bg-[#fff0a2] transition transform hover:scale-105"
        >
          See Project
        </button>
      </div>
