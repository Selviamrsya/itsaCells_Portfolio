      ...
      >
        <div className="relative flex items-center space-x-2">
          <div className="relative flex-shrink-0">
            <div className="relative w-12 h-12 rounded-2xl overflow-hidden border-2 border-[#99805E] hover:scale-105 transition-transform duration-300">
              <img
                src={profilePic}
                alt="profile"
              ...
              <div className="flex items-center">
                <div className="relative">
                  <img
                    src={flowerIcon2}
                    alt="flower"
                    className="w-4 h-4 mr-1 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12"
                  />
                </div>
